...
//
//	mockgen -source ./server.go -destination=./udpconn_mock.go -package=server
//
...
func (mr *MockUDPconnectionMockRecorder) ReadFromUDP(b any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUDPconnectionMockRecorder) Write(b any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
